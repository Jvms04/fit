...
| VAL-006 | Temporal/TZDB Node and Hermes vectors | Node 24 parcel executed: immutable bundle/hash, 5/5 vectors, skew detection, offline repeat, and future-rule reconciliation evidence | Hermes Android run not started | Hermes iOS unavailable | PARTIAL |
