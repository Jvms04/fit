...
| VAL-006 | Temporal/TZDB Node and Hermes vectors | Node 24 corpus/manifest/hash preparation is the next independent executable gate | Hermes Android run not started | Hermes iOS unavailable | NOT-EXECUTED |
